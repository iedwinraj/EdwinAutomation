...
public class LibrarianSendEmailmoduletest extends roleaccessBaseTest {
...
//	SendEmailmodulescreenspages = loginpage1.dousersSendEmailmoduleLogin(prop.getProperty("SchoolAccountHeadusername"), prop.getProperty("SchoolAccountHeadpassword"));
	...
	@Test(priority = 1,dataProvider="getdata") 
	  public void  LibrarianloginSendEmailMainmenureadTest(String SendEmailMainMenu, String SendEmailMainMenuRead,String SendEmailSubMenu,String SendEmailSubMenuRead,String SendEmailSubMenuCreate,String SendEmailSubMenuEdit,String SendEmailSubMenuDelete) {
		SendEmailmodulescreenspages.verifySendEmailMainMenu(SendEmailMainMenu, SendEmailMainMenuRead);
		
		  
	  }
	@Test(priority = 2,dataProvider="getdata") 
	  public void  LibrarianloginSendEmailsubmenuReadTest(String SendEmailMainMenu, String SendEmailMainMenuRead,String SendEmailSubMenu,String SendEmailSubMenuRead,String SendEmailSubMenuCreate,String SendEmailSubMenuEdit,String SendEmailSubMenuDelete) {
		SendEmailmodulescreenspages.verifySendEmailSubMenu(SendEmailSubMenu, SendEmailSubMenuRead);
	
		  
	  }
	@Test(priority = 3,dataProvider="getdata") 
	  public void  LibrarianloginSendEmailsubmenuCreateTest(String SendEmailMainMenu, String SendEmailMainMenuRead,String SendEmailSubMenu,String SendEmailSubMenuRead,String SendEmailSubMenuCreate,String SendEmailSubMenuEdit,String SendEmailSubMenuDelete) {
		SendEmailmodulescreenspages.verifySendEmailSubMenuCreate(SendEmailSubMenu, SendEmailSubMenuCreate);
	
	  }
	@Test(priority = 4,dataProvider="getdata") 
	  public void  LibrarianloginSendEmailsubmenuEditTest(String SendEmailMainMenu, String SendEmailMainMenuRead,String SendEmailSubMenu,String SendEmailSubMenuRead,String SendEmailSubMenuCreate,String SendEmailSubMenuEdit,String SendEmailSubMenuDelete) {
		SendEmailmodulescreenspages.verifySendEmailSubMenuEdit(SendEmailSubMenu, SendEmailSubMenuEdit);
	
	  }
	
	@Test(priority = 5,dataProvider="getdata") 
	  public void  LibrarianloginSendEmailsubmenuDeleteTest(String SendEmailMainMenu, String SendEmailMainMenuRead,String SendEmailSubMenu,String SendEmailSubMenuRead,String SendEmailSubMenuCreate,String SendEmailSubMenuEdit,String SendEmailSubMenuDelete) {
