...
public class PrincipalloginOnlineVideosmoduletest extends roleaccessBaseTest{
@BeforeClass
...
//		OnlineVideosmodulescreenspages = loginpage1.dousersOnlineVideosmoduleLogin(prop.getProperty("SchoolAccountHeadusername"), prop.getProperty("SchoolAccountHeadpassword"));
	...
	@Test(priority = 1,dataProvider="getdata") 
	  public void  PrincipalloginOnlineVideosMainmenureadTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosMainMenu(OnlineVideosMainMenu, OnlineVideosMainMenuRead);
		
		  
	  }
	@Test(priority = 2,dataProvider="getdata") 
	  public void  PrincipalloginOnlineVideossubmenuReadTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenu(OnlineVideosSubMenu,OnlineVideosSubMenuRead);
	
		  
	  }
	@Test(priority = 3,dataProvider="getdata") 
	  public void  PrincipalloginOnlineVideossubmenuCreateTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenuCreate(OnlineVideosSubMenu,OnlineVideosSubMenuCreate);
	
	  }
	@Test(priority = 4,dataProvider="getdata") 
	  public void  PrincipalloginOnlineVideossubmenuEditTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenuEdit(OnlineVideosSubMenu,OnlineVideosSubMenuEdit);
	
	  }
	
	@Test(priority = 5,dataProvider="getdata") 
	  public void  PrincipalloginOnlineVideossubmenuDeleteTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
