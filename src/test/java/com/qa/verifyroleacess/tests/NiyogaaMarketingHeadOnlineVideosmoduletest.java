...
public class NiyogaaMarketingHeadOnlineVideosmoduletest extends roleaccessBaseTest {
...
//		OnlineVideosmodulescreenspages = loginpage1.dousersOnlineVideosmoduleLogin(prop.getProperty("SchoolAccountHeadusername"), prop.getProperty("SchoolAccountHeadpassword"));
	...
	@Test(priority = 1,dataProvider="getdata") 
	  public void  NiyogaaMarketingHeadloginOnlineVideosMainmenureadTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosMainMenu(OnlineVideosMainMenu, OnlineVideosMainMenuRead);
		
		  
	  }
	@Test(priority = 2,dataProvider="getdata") 
	  public void  NiyogaaMarketingHeadloginOnlineVideossubmenuReadTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenu(OnlineVideosSubMenu,OnlineVideosSubMenuRead);
	
		  
	  }
	@Test(priority = 3,dataProvider="getdata") 
	  public void  NiyogaaMarketingHeadloginOnlineVideossubmenuCreateTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenuCreate(OnlineVideosSubMenu,OnlineVideosSubMenuCreate);
	
	  }
	@Test(priority = 4,dataProvider="getdata") 
	  public void  NiyogaaMarketingHeadloginOnlineVideossubmenuEditTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenuEdit(OnlineVideosSubMenu,OnlineVideosSubMenuEdit);
	
	  }
	
	@Test(priority = 5,dataProvider="getdata") 
	  public void  NiyogaaMarketingHeadloginOnlineVideossubmenuDeleteTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
