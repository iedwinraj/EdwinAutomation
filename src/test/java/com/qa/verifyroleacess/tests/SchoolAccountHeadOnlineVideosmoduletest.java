...
public class SchoolAccountHeadOnlineVideosmoduletest extends roleaccessBaseTest {
@BeforeClass
...
//		OnlineVideosmodulescreenspages = loginpage1.dousersOnlineVideosmoduleLogin(prop.getProperty("NiyogaaFinanceHeadusername"), prop.getProperty("NiyogaaFinanceHeadpassword"));
	...
	@Test(priority = 1,dataProvider="getdata") 
	  public void  SchoolAccountHeadloginOnlineVideosMainmenureadTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosMainMenu(OnlineVideosMainMenu, OnlineVideosMainMenuRead);
		
		  
	  }
	@Test(priority = 2,dataProvider="getdata") 
	  public void  SchoolAccountHeadloginOnlineVideossubmenuReadTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenu(OnlineVideosSubMenu,OnlineVideosSubMenuRead);
	
		  
	  }
	@Test(priority = 3,dataProvider="getdata") 
	  public void  SchoolAccountHeadloginOnlineVideossubmenuCreateTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenuCreate(OnlineVideosSubMenu,OnlineVideosSubMenuCreate);
	
	  }
	@Test(priority = 4,dataProvider="getdata") 
	  public void  SchoolAccountHeadloginOnlineVideossubmenuEditTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
		OnlineVideosmodulescreenspages.verifyOnlineVideosSubMenuEdit(OnlineVideosSubMenu,OnlineVideosSubMenuEdit);
	
	  }
	
	@Test(priority = 5,dataProvider="getdata") 
	  public void  SchoolAccountHeadloginOnlineVideossubmenuDeleteTest(String OnlineVideosMainMenu, String OnlineVideosMainMenuRead,String OnlineVideosSubMenu,String OnlineVideosSubMenuRead,String OnlineVideosSubMenuCreate,String OnlineVideosSubMenuEdit,String OnlineVideosSubMenuDelete) {
